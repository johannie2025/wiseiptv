 ...
 * Lancer depuis MainActivity via Settings ou bouton "Playlists".
 */
public class PlaylistManagerActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        filePicker = registerForActivityResult(
            ...
            uri -> { if (uri != null) { pickedFileUri = uri; updateFileLabel(uri); }}
        );
    ...
    private void showAddDialog() {
        ...
        TextView tvFile   = v.findViewById(R.id.tv_file_path);
        ...
        b.setPositiveButton("Charger", (d, w) -> {
            ...
            if (cid == R.id.rb_xtream) {
                ...
                if (pickedFileUri == null) { Toast.makeText(this,"Sélectionner un fichier",Toast.LENGTH_SHORT).show(); return; }
                // Copier l'URI persistante
            ...
            // EPG optionnel (stocké dans password pour Xtream ou url_epg séparé)
    ...
    private void updateFileLabel(Uri uri) {
        View v = rv.getRootView().findViewWithTag("dialog_file_label");
        if (v instanceof TextView) ((TextView)v).setText(uri.getLastPathSegment());
    }
    ...
    class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.VH> {
        ...
        class VH extends RecyclerView.ViewHolder {
            ...
            void bind(PlaylistEntity pl) {
                ...
                tvStatus.setText(pl.lastUpdated==0 ? "Jamais chargé" :
                    "Mis à jour il y a " + (age/3600000) + "h");
            }
        }
    }
    ...
    private void refresh(int pos) {
        ...
        showProgress(true);
        PlaylistLoader.load(pl, db, new PlaylistLoader.Callback() {
            @Override public void onDone(int c) { runOnUiThread(() -> { showProgress(false);
                Toast.makeText(PlaylistManagerActivity.this,c+" chaînes",Toast.LENGTH_SHORT).show(); }); }
            @Override public void onError(String m) { runOnUiThread(() -> { showProgress(false);
